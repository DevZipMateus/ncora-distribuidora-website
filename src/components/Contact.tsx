  ...
  },
  {
    ...
    content: (
      <a
        ...
        className="text-muted-foreground text-xs sm:text-sm hover:text-accent transition-colors"
      >
        (49) 99973-9747
      </a>
    ),
  },
  {
    ...
    content: (
      <a
        ...
        className="text-muted-foreground text-xs sm:text-sm hover:text-accent transition-colors break-all"
      >
